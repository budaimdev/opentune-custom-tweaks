...
class ExoDownloadService : DownloadService(
    ...
    override fun getForegroundNotification(
        ...
        val activeDownload =
            downloads.find { it.state == Download.STATE_DOWNLOADING || it.state == Download.STATE_RESTARTING }
        ...
        val isPaused =
            downloadManager.downloadsPaused || downloads.all { it.state == Download.STATE_QUEUED || it.state == Download.STATE_RESTARTING }
        ...
        val cancelAllAction = Notification.Action.Builder(
            ...
            PendingIntent.getService(
                ...
                ).setAction(REMOVE_ALL_PENDING_DOWNLOADS),
                PendingIntent.FLAG_IMMUTABLE
            )
        ).build()
