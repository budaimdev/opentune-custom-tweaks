...
fun SpotifyPlayerContent(
    ...
    mediaMetadata.artists.forEach { artist ->
        ...
        val thumbnailUrl =
            artistEntity?.thumbnailUrl?.takeIf { it.isNotBlank() } ?: mediaMetadata.thumbnailUrl
        SpotifyArtistCard(
            artist = artist.name,
            artistId = artist.id,
        ...
        when {
            ...
            lyrics.startsWith("[") -> com.arturo254.opentune.lyrics.LyricsUtils.parseLyrics(lyrics)
                ...
                .mapIndexed { index, line ->
                    com.arturo254.opentune.lyrics.LyricsEntry(
                        index * 2500L,
                        line
                    )
                }
...
private fun SpotifyArtistCard(
    ...
    val avatarUrl by produceState<String?>(
...
private fun SpotifyDetailsCard(
    ...
    Box(
        ...
        Column {
            Text(
                text = mediaMetadata.album?.title?.takeIf { it.isNotBlank() }
                    ?: mediaMetadata.title,
                style = MaterialTheme.typography.headlineSmall,
                fontWeight = FontWeight.ExtraBold,
                color = Color.White,
