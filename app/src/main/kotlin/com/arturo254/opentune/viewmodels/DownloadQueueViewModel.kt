...
class DownloadQueueViewModel @Inject constructor(
    ...
    val downloadsPaused = callbackFlow {
        ...
        downloadUtil.downloadManager.downloadsPaused
    )
    ...
    fun pauseAll() {
        ...
        ).setAction(ExoDownloadService.PAUSE_DOWNLOADS)
    ...
    fun resumeAll() {
        val intent = Intent(
            context,
            ExoDownloadService::class.java
        ).setAction(ExoDownloadService.RESUME_DOWNLOADS)
        context.startService(intent)
    }
    ...
    fun removeAll() {
        val intent = Intent(
            context,
            ExoDownloadService::class.java
        ).setAction(ExoDownloadService.REMOVE_ALL_PENDING_DOWNLOADS)
        context.startService(intent)
    }
}
